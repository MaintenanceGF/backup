...
function create() {
    ...
    const data = `INSERT INTO quimicos (folio, code, quantity, line, request_date, requester, authorized) VALUES (${folio}, "${code}", ${quantity}, "${line}", "${request_date}", "${requester}", "${authorized}")`
